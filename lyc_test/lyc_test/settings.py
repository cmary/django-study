"""
Django settings for lyc_test project.
...
SECRET_KEY = 'w2efs=6x6hsksn-vt6thhib2684rja$%ym12cu(@t^e)%l(d!&'
...
WSGI_APPLICATION = 'lyc_test.wsgi.application'
